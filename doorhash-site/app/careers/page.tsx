        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <Reveal>
            <h2 className="text-display-3 font-display text-cream mb-4 text-balance">
              Who we&apos;re <span className="gradient-text">hiring.</span>
            </h2>
            ...
            {teams.map((t, i) => (
              <Reveal key={t.name} delay={i * 0.06}>
                <div className="rounded-3xl glass p-8 h-full hover:border-leaf-500/20 transition-colors">
                  ...
                  <h3 className="font-display text-cream text-2xl font-bold mb-3">{t.name}</h3>
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-10">
          <Reveal>
            ...
            <ul className="space-y-4">
              {values.map((v) => (
                <li key={v} className="flex items-start gap-3 text-ink-200">
                  <span className="mt-1.5 inline-block w-2 h-2 rounded-full bg-leaf-400 shrink-0 shadow-glow-leaf" />
        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-10">
          <Reveal>
            <div className="rounded-3xl glass-leaf p-10 text-center">
              <h2 className="text-display-3 font-display text-cream mb-4">Ready to apply?</h2>
              <p className="text-ink-200 text-pretty mb-8">
