        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <Reveal>
            <h2 className="text-display-3 font-display text-white mb-4 text-balance">
              Who we&apos;re <span className="text-leaf-300">hiring.</span>
            </h2>
            ...
            {teams.map((t, i) => (
              <Reveal key={t.name} delay={i * 0.06}>
                <div className="rounded-3xl card-dark p-8 h-full">
                  ...
                  <h3 className="font-display text-white text-2xl font-bold mb-3">{t.name}</h3>
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-10">
          <Reveal>
            ...
            <ul className="space-y-4">
              {values.map((v) => (
                <li key={v} className="flex items-start gap-3 text-white">
        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-10">
          <Reveal>
            <div className="rounded-3xl card-dark-leaf p-10 text-center">
              <h2 className="text-display-3 font-display text-white mb-4">Ready to apply?</h2>
              <p className="text-white/70 text-pretty mb-8">
