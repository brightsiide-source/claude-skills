...
<required_reading>
Read `/home/user/claude-skills/doorhash-site/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
