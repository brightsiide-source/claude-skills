...
Use template from `/home/user/claude-skills/doorhash-site/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user/claude-skills/doorhash-site/.claude/get-shit-done/templates/UI-SPEC.md`
