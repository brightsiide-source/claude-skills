...
<required_reading>
@/home/user/claude-skills/doorhash-site/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/claude-skills/doorhash-site/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/claude-skills/doorhash-site/.claude
                  → checks /home/user/claude-skills/doorhash-site/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/claude-skills/doorhash-site/.claude/get-shit-done
                  → writes to /home/user/claude-skills/doorhash-site/.claude/get-shit-done/hooks/
...
@/home/user/claude-skills/doorhash-site/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/claude-skills/doorhash-site/.claude/get-shit-done/references/common-bug-patterns.md
