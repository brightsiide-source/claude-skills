...
<execution_context>
@/home/user/claude-skills/doorhash-site/.claude/get-shit-done/workflows/update.md
</execution_context>
...
- Otherwise: **Follow the update workflow** from `@/home/user/claude-skills/doorhash-site/.claude/get-shit-done/workflows/update.md`.
...
@/home/user/claude-skills/doorhash-site/.claude/get-shit-done/workflows/sync-skills.md
@/home/user/claude-skills/doorhash-site/.claude/get-shit-done/workflows/reapply-patches.md
</execution_context_extended>
