...
<execution_context>
@/home/user/claude-skills/doorhash-site/.claude/get-shit-done/workflows/health.md
</execution_context>

<process>
Execute the health workflow from @/home/user/claude-skills/doorhash-site/.claude/get-shit-done/workflows/health.md end-to-end.
