...
<execution_context>
@/home/user/claude-skills/doorhash-site/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/home/user/claude-skills/doorhash-site/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
