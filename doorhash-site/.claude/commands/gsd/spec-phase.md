...
<execution_context>
@/home/user/claude-skills/doorhash-site/.claude/get-shit-done/workflows/spec-phase.md
@/home/user/claude-skills/doorhash-site/.claude/get-shit-done/templates/spec.md
</execution_context>
...
<process>
Execute the spec-phase workflow from @/home/user/claude-skills/doorhash-site/.claude/get-shit-done/workflows/spec-phase.md end-to-end.
