...
```
Task(
  prompt="Read /home/user/claude-skills/doorhash-site/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/claude-skills/doorhash-site/.claude/get-shit-done/templates/SECURITY.md`
