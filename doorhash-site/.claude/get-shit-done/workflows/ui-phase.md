...
```markdown
Read /home/user/claude-skills/doorhash-site/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/claude-skills/doorhash-site/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/claude-skills/doorhash-site/.claude/agents/gsd-ui-checker.md for instructions.
