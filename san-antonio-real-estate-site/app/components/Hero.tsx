...
export default function Hero() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError("Something went wrong. Please call us directly at (830) 590-1105.");
    } finally {
      setSubmitting(false);
    }
  }
          ...
          <div className="order-first lg:order-last bg-white rounded-xl shadow-2xl p-8 lg:ml-8">
            {submitted ? (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-sand-dark">Need to talk sooner? Call <a href="tel:+18305901105" className="text-terra font-semibold">(830) 590-1105</a></p>
              </div>
            ) : (
              <>
                ...
                <form name="quick-offer" method="POST" data-netlify="true" onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {error && (
                    <div className="bg-red-50 border border-red-200 rounded-md p-3 text-sm text-red-700">
                      {error} <a href="tel:+18305901105" className="font-semibold underline">(830) 590-1105</a>
                    </div>
                  )}
