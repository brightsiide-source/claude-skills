export default function CTAForm() {
  return (
    <section id="get-offer" className="py-24 bg-black relative overflow-hidden">
      {/* Decorative gradient */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-teal/10 rounded-full blur-3xl" />

      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4">
            Ready to Get Your <span className="text-teal">Cash Offer</span>?
          </h2>
          <p className="text-lg text-silver-dark max-w-xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-2xl p-8 sm:p-10">
          <form className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-black mb-1.5">Property Address *</label>
              <input
                type="text"
                required
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                <label className="block text-sm font-medium text-black mb-1.5">Property Condition</label>
              ...
              <div>
                <label className="block text-sm font-medium text-black mb-1.5">Timeline to Sell</label>
                <select className="w-full px-4 py-3 rounded-md border border-silver bg-silver-light text-silver-dark focus:outline-none focus:ring-2 focus:ring-teal focus:border-transparent">
            ...
            <div>
              <label className="block text-sm font-medium text-black mb-1.5">Anything else we should know?</label>
              <textarea
                rows={3}
                placeholder="Tell us about your situation (optional)"
                className="w-full px-4 py-3 rounded-md border border-silver bg-silver-light text-black placeholder:text-silver-dark focus:outline-none focus:ring-2 focus:ring-teal focus:border-transparent resize-none"
              />
            </div>
