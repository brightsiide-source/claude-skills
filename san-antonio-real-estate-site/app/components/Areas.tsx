export default function Areas() {
  ...
  return (
    <section id="areas" className="py-24 bg-limestone">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-adobe mb-4">
              Buying Houses Across{" "}
              <span className="text-terra">Greater San Antonio</span>
            </h2>
            <p className="text-lg text-sand-dark mb-8">
            ...
            <a
              href="#get-offer"
              className="inline-flex items-center gap-2 bg-terra hover:bg-terra-dark text-white px-8 py-4 rounded-md text-lg font-bold transition-colors"
            >
          ...
          <div>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-8">
              {areas.map((area) => (
                <div
                  key={area}
                  className="bg-white rounded-lg px-4 py-3 text-sm font-medium text-adobe border border-limestone-dark hover:border-terra/50 hover:text-terra transition-colors text-center"
                >
                  {area}
                </div>
              ))}
            ...
            <div className="rounded-xl overflow-hidden border border-limestone-dark shadow-sm">
              <iframe
