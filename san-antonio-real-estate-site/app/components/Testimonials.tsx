export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-24 bg-adobe">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4">
            What Our <span className="text-terra">Sellers Say</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((t) => (
            <div
              key={t.name}
              className="bg-white/5 border border-white/10 rounded-xl p-8 hover:border-terra/30 transition-colors"
            >
              ...
              <blockquote className="text-sand mb-6 leading-relaxed italic">
                &ldquo;{t.quote}&rdquo;
              </blockquote>
              <div>
                <div className="font-bold text-white">{t.name}</div>
                <div className="text-terra text-sm">{t.location}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="text-center mt-12">
          <a href="/contact" className="inline-flex items-center gap-2 bg-terra hover:bg-terra-dark text-white px-8 py-4 rounded-md text-lg font-bold transition-colors">
