...
export const metadata: Metadata = {
  ...
  description:
    "Professional gutter installation, repair, and replacement in Central Iowa. Protect your foundation with efficient water drainage from S&C Exteriors.",
};

const services = [
  {
    title: "Gutter Installation",
    description: "New gutter systems designed and installed to perfectly match your roofline and efficiently channel water away from your foundation.",
  },
  {
    title: "Gutter Replacement",
    description: "Upgrade old, damaged, or undersized gutters with modern systems built to handle Central Iowa's heavy rains and snowmelt.",
  },
  {
    title: "Gutter Repair",
    description: "Fix leaks, sagging sections, loose fasteners, and other gutter issues before they cause costly water damage to your property.",
  },
  {
    title: "Gutter Removal",
    description: "Safe and clean removal of old gutters as part of a replacement project or exterior renovation.",
  },
  {
    title: "Downspout Services",
    description: "Proper downspout placement and extensions to direct water well away from your foundation, basement, and landscaping.",
  },
  {
    title: "Gutter Guards",
    description: "Keep leaves and debris out of your gutters with professionally installed gutter protection systems that reduce maintenance.",
  },
];
...
const signs = [
  ...
  "Paint peeling on or near gutters",
  "Sagging or uneven gutter sections",
  "Water marks or mildew beneath gutters",
      ...
      <section className="bg-brand-navy text-white section-padding !pb-32">
        <div className="container-max">
          ...
          <p className="text-white/80 text-xl max-w-3xl leading-relaxed">
            ...
            repair, and replacement services. S&C Exteriors ensures efficient water
            drainage for homes and businesses across Central Iowa.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-brand-slate leading-relaxed mb-8">
                Don&apos;t wait until water damage becomes expensive. If you notice any of
                these signs, it&apos;s time to call S&C Exteriors for a free inspection.
              </p>
            ...
            <div className="bg-brand-navy rounded-2xl p-10 text-white">
              ...
              <div className="space-y-4 text-white/80 leading-relaxed">
                <p>
                  Gutters are your property&apos;s first line of defense against water damage.
                  They channel rainwater and snowmelt safely away from your roof, walls,
                  and foundation.
                </p>
                <p>
                  Without properly functioning gutters, water can erode your landscaping,
                  damage your siding, cause foundation cracks, and lead to costly
                  basement flooding.
                </p>
                <p>
                  Central Iowa gets an average of 35+ inches of rain per year, plus
                  significant snowfall. Your gutters work hard — make sure they&apos;re up
                  to the task.
                </p>
              </div>
            </div>
      ...
      <section className="bg-brand-navy text-white section-padding">
        <div className="container-max text-center">
          ...
          <p className="text-white/70 text-lg max-w-2xl mx-auto mb-10">
            Get a free gutter inspection and estimate from S&C Exteriors.
          </p>
