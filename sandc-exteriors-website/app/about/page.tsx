...
export const metadata: Metadata = {
  ...
  description: "Learn about S&C Exteriors — Central Iowa's trusted exterior contractor. Professional roofing, siding, gutter, and concrete services in Johnston, IA.",
};
...
const values = [
  ...
  { title: "Community First", description: "As a local Johnston business, we treat every customer like a neighbor. Your satisfaction is our reputation, and we take that seriously.", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" },
...
const glanceItems = [
  { label: "Based in Johnston, IA", sub: "Serving all of Central Iowa", icon: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" },
      ...
      <section className="bg-brand-black text-white section-padding !pb-32 relative overflow-hidden">
        ...
        <div className="relative container-max">
          ...
          <p className="text-white/70 text-xl max-w-3xl leading-relaxed">
            S&C Exteriors is your dedicated partner for all things roofing, siding, gutters, and concrete. With a commitment to excellence and years of experience, we handle all residential and commercial exterior needs across Central Iowa.
          </p>
        </div>
      </section>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <div className="space-y-4 text-brand-slate leading-relaxed">
                    <p>S&C Exteriors was founded right here in Johnston, Iowa with a simple mission: provide Central Iowa homeowners and businesses with exceptional exterior services at fair prices.</p>
