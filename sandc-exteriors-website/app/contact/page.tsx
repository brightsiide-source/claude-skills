    ...
    <>
      ...
      <section className="bg-brand-black text-white section-padding !pb-32">
        <div className="container-max">
          <span className="text-brand-silver font-semibold text-sm uppercase tracking-wider">Contact Us</span>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mt-3 mb-6">
            Get Your <span className="text-brand-silver">Free Estimate</span>
          </h1>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
              ...
              <form className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      name="firstName"
                      required
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-brand-charcoal focus:ring-0 focus:outline-none transition-colors"
                      placeholder="John"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <select
                    ...
                    name="service"
                    required
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-brand-charcoal focus:ring-0 focus:outline-none transition-colors bg-white"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={5}
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-brand-charcoal focus:ring-0 focus:outline-none transition-colors resize-vertical"
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <a
                  href="tel:5157831896"
                  className="flex items-center gap-3 text-2xl font-bold text-brand-black hover:text-brand-charcoal transition-colors"
                >
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <a
                  ...
                  className="flex items-center gap-3 text-brand-charcoal hover:text-brand-black transition-colors font-medium"
                >
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <a
                  ...
                  className="flex items-center gap-3 text-brand-slate hover:text-brand-black transition-colors"
                >
